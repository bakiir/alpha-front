        ...
        <section class="profile-content">
          ...
          <section v-else class="cabinet-section">
            ...
            <div v-else-if="activeSection === 'support'" class="content-panel">
              <p class="support-intro">Свяжитесь с нами удобным способом.</p>
              <ContactChannels />
            </div>
          ...
          <div class="buy-modal payment-modal">
            ...
            <div class="buy-details-card">
              <div class="price-row" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <span class="special-price" style="color: #3F6757; font-weight: 800; font-size: 18px;">{{ formatPrice(payingRental.total_price) }} ₸</span>
              </div>
            </div>
        ...
        <div v-if="extendingRental" class="modal-overlay" @click.self="extendingRental = null">
          <div class="buy-modal">
            ...
            <div class="buy-details-card">
              ...
              <div class="price-row" style="display: flex; justify-content: space-between; align-items: center;">
                <span>Доплата:</span>
                <span class="special-price" style="color: #3F6757; font-weight: 800; font-size: 18px;">+{{ formatPrice(extendDays * (extendingRental.daily_rate || 1500)) }} ₸</span>
              </div>
            </div>
...
.welcome-avatar.authenticated {
  color: var(--green-ink);
  background: linear-gradient(135deg, var(--green-surface), var(--green-surface-hover));
}
...
.favorite-info strong { display: block; margin-bottom: 12px; color: var(--green-ink); }
...
.address-card.default { border-color: var(--green-ink); }
.default-badge { font-size: 11px; background: #D9E0D5; color: var(--green-ink); padding: 2px 8px; border-radius: 8px; margin-left: 8px; }
